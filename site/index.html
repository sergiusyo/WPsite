        ...
        <div class="container">
            <nav class="menu__desktop">
                <ul class="menu">
                    ...
                    <li class="menu__item"><a href="#"><img class="logo" src="img/logo.png" alt=""></a></li>
        ...
        <div class="container">
            ...
            <div class="provide__inner">
                <div class="provide__item">
                    ...
                    <h3 class="team__item-title">Some Analytics</h3>
                    <p class="provide__item-text">Aenean nisi lectus, convallis non lorem sit amet, rhoncus malesuada
                        justo</p>
                </div>
                <div class="provide__item">
                    <i class="icon-heart"></i>
                    <h3 class="team__item-title">We provide you love</h3>
                    <p class="provide__item-text">Aenean nisi lectus, convallis non lorem sit amet, rhoncus malesuada
                        justo</p>
                </div>
                <div class="provide__item">
                    <i class="icon-upload-cloud-outline"></i>
                    <h3 class="team__item-title">And Some Cloud</h3>
                    <p class="provide__item-text">Aenean nisi lectus, convallis non lorem sit amet, rhoncus malesuada
                        justo</p>
                </div>
            </div>
            ...
            <div class="contact__inner">
                <div class="contact__icon-box">
                    ...
                    <div class="contact__item">
                        ...
                        <div class="contact__text"><a href="https://goo.gl/maps/xtdsy4yPZKUsQnEd6" target="_blank">Here
                                is some address</a></div>
                    </div>
                    <div class="contact__item">
                        <i class="icon-mail-alt"></i>
                        <div class="contact__text"><a href="mailto:somemail@hotmail.com"></a> somemail@hotmail.com</div>
                    </div>
                </div>
